...
import service.producer.NowProducerService.nowWeatherProducer
import service.{Hour24GatewayApiService, NowGatewayApiService}
import util.DbPool
...
object Hour24ProducerService {
  ...
  def nowWeatherProducer(producer: KafkaProducer[String, String], area: String = "盂县"): scala.collection.mutable.HashMap[String, String] = {
    ...
    val nowWeatherJson = Hour24GatewayApiService.get24HourWentyData(area)
    val record: ProducerRecord[String, String] = new ProducerRecord[String, String]("Hour24WeatherData", nowWeatherJson)
    try {
  ...
  def main(args: Array[String]): Unit = {
    ...
    kafkaProps.put("bootstrap.servers", "192.168.2.2:9092, 192.168.2.3:9092, 192.168.2.4:9092");
