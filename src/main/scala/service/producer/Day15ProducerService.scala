...
import service.producer.Hour24ProducerService.nowWeatherProducer
import service.{Day15GatewayApiService, Hour24GatewayApiService}
import util.DbPool
...
object Day15ProducerService {
  ...
  def nowWeatherProducer(producer: KafkaProducer[String, String], area: String = "盂县"): scala.collection.mutable.HashMap[String, String] = {
    ...
    val day15eatherJson = Day15GatewayApiService.get15DayWentyData(area)
    val record: ProducerRecord[String, String] = new ProducerRecord[String, String]("Day15WeatherData", day15eatherJson)
    try {
